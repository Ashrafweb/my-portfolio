...
import ReactAgencyImg from "../../public/assets/images/react-agency.png"
import InstantPickupImg from "../../public/assets/images/instantpickup.png"
...
export const projectData = [
    {
        ...
        imgUrl: climaWeatherImg,
        description: "A weather website using openweather api data and built with react , shadcn and tanstack query",
    ...
    },
    {
        ...
        description: "Netflix UI clone built using React.js , firebase and styled using styled components",
    ...
    {
        id: 5,
        title: 'RealTime Chat App with Firebase and Next.js',
        alt: 'nextjs-firebase-chat',
        imgUrl: WhatsappCloneImg,
    ...
    },
    {
        ...
        description: "Eco-friendly house and office mover service web app using next.js",
